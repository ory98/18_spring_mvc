...
public class HomeController {
	...
	public String home() { // jsp파일 이름이 String이기 때문에 return type이 대부분 String이다. ()안에서 선언한다. 
		 ...
		 *			<beans:property name="prefix" value="/WEB-INF/views/" /> : 앞에 붙이고
		 *			<beans:property name="suffix" value=".jsp" />			 : 뒤에 붙이고
		 *	    </beans:bean>
		 *
		 *		예시)
		 *
		...
		return "home"; // return "jsp파일" = requestDispatch
	}
